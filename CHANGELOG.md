 ...
 * **Uncategorized**
    ...
    - More tests for more coverage. ([`0e9667b`](https://github.com/Byron/jwalk/commit/0e9667bf6cbe748cc17e9ec03637aa7b64a155fe))
    - Merge pull request #39 from g2p/custom-state-recursion ([`d0f7661`](https://github.com/Byron/jwalk/commit/d0f7661ea3d87169b916ce209e945b55b77d8505))
    - Switch version to indicate breakage. ([`da88aa2`](https://github.com/Byron/jwalk/commit/da88aa2932c109253c60eee41afdd319c8e9af35))
    - Allow per-child overrides of ReadDirState in process_read_dir ([`0f5bb5d`](https://github.com/Byron/jwalk/commit/0f5bb5d7bf7c3ec2af336552515d6d412759d83d))
    - Fix badges and update some formatting ([`9bef02a`](https://github.com/Byron/jwalk/commit/9bef02a3d1b200a9c388555858430d4c8f52a2df))
    - Merge pull request #36 from atouchet/rdme ([`d6e4c74`](https://github.com/Byron/jwalk/commit/d6e4c74b32dcaeb46bc8394c184de9b82c06309c))
    - Fix badges and update some formatting ([`0b15eb4`](https://github.com/Byron/jwalk/commit/0b15eb4c5f2d3d8ded9717cefc9b5da8f8e8cfe7))
    - Merge pull request #44 from Flamenco/patch-1 ([`bc78d48`](https://github.com/Byron/jwalk/commit/bc78d4867a6f8943c8ceecdc900f1ee26d0f3084))
    - Merge pull request #42 from joshtriplett/tyop ([`27101f5`](https://github.com/Byron/jwalk/commit/27101f575e631c8c40e69fe69eb4c708003c25b1))
    - Fix typo ([`cd4ff42`](https://github.com/Byron/jwalk/commit/cd4ff4279766d19ca3f7c56e86c9f1356e926d91))
    - Typo fix ([`dc9ae7c`](https://github.com/Byron/jwalk/commit/dc9ae7c9a5cc65e9b1940ff467b6365094651698))
    - Merge branch 'fastest-find' ([`7f43a24`](https://github.com/Byron/jwalk/commit/7f43a246e05037a7bc7d53b712c086f4b0983eed))
    - Add new 'count' example to count as fast as possible ([`a1c624f`](https://github.com/Byron/jwalk/commit/a1c624f1d6bfd71283d0e08b3aa5c4321d93eafd))
    - Upgrade to Rust 2021 for more code clarity ([`1a0d6bf`](https://github.com/Byron/jwalk/commit/1a0d6bf46f1f23f3be24f9c4a66b0bbac2857b8f))
    - Shared arguments for example ([`b30afb3`](https://github.com/Byron/jwalk/commit/b30afb342ebb5a687f0cdf5e217ce88d9507569f))
    - Thanks clippy ([`18b2d9b`](https://github.com/Byron/jwalk/commit/18b2d9b42c17ce5c0f18d1eca85155014211f519))
</details>
 ...
 * **Uncategorized**
    - Release jwalk v0.8.1 ([`0079deb`](https://github.com/Byron/jwalk/commit/0079deb9faed6be48e77676494351f06411db5de))
 ...
 * **Uncategorized**
    ...
    -  ([`64ddb05`](https://github.com/Byron/jwalk/commit/64ddb05cbc130b865cc872d1e56c4ef71ad1a9bd))
 ...
 * **Uncategorized**
    ...
    -  ([`b330914`](https://github.com/Byron/jwalk/commit/b3309145eee88c8b48daf1453d68e5d6d98d3ce7))
    -  ([`0f8b1c8`](https://github.com/Byron/jwalk/commit/0f8b1c8350c4d31e6de88fddbc7fd61ecd990065))
